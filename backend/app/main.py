...
Registra el router de `vehiculos` (Block 3 de FEAT-001a) y el de `reservas`
(Block 3 de FEAT-001c), CORS restringido al origen exacto del frontend
(nunca `["*"]`, ver AGENTS.md) y un exception handler genérico para
cualquier error no anticipado por ninguno de los dos routers: loguea el
...
from app.features.reservas.router import router as reservas_router
